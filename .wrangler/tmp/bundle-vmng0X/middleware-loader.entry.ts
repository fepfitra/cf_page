...
import {
	...
	__facade_invoke__,
	__facade_register__,
} from "/home/fep/GitProject/cf_page/node_modules/wrangler/templates/middleware/common.ts";

import worker from "/home/fep/GitProject/cf_page/.wrangler/tmp/bundle-vmng0X/middleware-insertion-facade.js";

// We need to preserve all of the exports from the worker
export * from "/home/fep/GitProject/cf_page/.wrangler/tmp/bundle-vmng0X/middleware-insertion-facade.js";
